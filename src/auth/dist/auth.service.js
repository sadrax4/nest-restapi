...
var AuthService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.prisma.user.create({ data: userData })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, { msg: "user created successfully" }];
                    case 3:
                        error_1 = _a.sent();
    ...
    AuthService.prototype.signup = function (dto) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.user.findFirst({ where: { email: dto.email } })];
                    case 1:
                        user = _a.sent();
                        if (!user)
                    ...
                    case 2:
                        pwCompare = _a.sent();
                        if (!pwCompare)
                            throw new common_1.ForbiddenException("email or password is invalid");
                        return [2 /*return*/, this.singToken(user.id, user.email)];
                }
            });
        });
    };
